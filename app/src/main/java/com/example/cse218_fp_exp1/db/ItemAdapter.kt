...
import com.example.cse218_fp_exp1.databinding.ItemsRowBinding
...
class ItemAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvXcoord.text = item.xCoordinate
        holder.tvYcoord.text = item.yCoordinate
...
//end
    ...
    class ViewHolder(binding: ItemsRowBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        val tvXcoord = binding.tvXcoord
        val tvYcoord = binding.tvYcoord
